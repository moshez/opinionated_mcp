...
class TestSetupRoutes(unittest.TestCase):
    def setUp(self):
        ...
        setup_routes(self.app, self.oauth_handler, "Test Server", "http://localhost:8000")
    ...
    def test_login_route(self):
        ...
        with TestClient(self.app) as client:
            ...
            assert_that(response.headers["location"], contains_string("accounts.google.com"))
    ...
    def test_callback_route_success(self):
        ...
        with TestClient(self.app) as client:
            ...
            response = client.get(f"/callback?code=test_code&state={actual_state}", headers=headers)
    ...
    def test_current_user_route_authenticated(self):
        ...
        with TestClient(self.app) as client:
            ...
            headers = {"cookie": session_cookie} if session_cookie else {}
            callback_response = client.get(f"/callback?code=test_code&state={actual_state}", headers=headers)
    ...
    def test_current_user_route_invalid_session(self):
        ...
        with TestClient(self.app) as client:
            ...
            with patch.object(self.oauth_handler, 'get_user_from_request') as mock_get_user:
                # First call returns None (simulating invalid session even though authenticated=True)
